...
@section('title','Deleted Posts | Admin')
@section('container')
                        ...
                        <table class="table table-hover" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $post->title }}</td>
                                    <td><a href="{{ route('post.restore',[$post->id ]) }}" class="btn btn-primary">Restore</a>
                                <a href="{{ route('post.destroy',[$post->id ]) }}" class="btn btn-danger" id="delete">Delete</a></td>
                                </tr>
                                @endforeach
