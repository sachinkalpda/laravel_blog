                        ...
                        <table class="table table-hover" id="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $author->name }}</td>
                                    <td><a href="{{ route('admin.restore',[$author->id ]) }}" class="btn btn-primary">Restore</a>
                                <a href="{{ route('admin.destroy',[$author->id ]) }}" class="btn btn-danger" id="delete">Delete</a></td>
                                </tr>
                                @endforeach
